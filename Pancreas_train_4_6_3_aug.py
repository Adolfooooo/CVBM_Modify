...
from dataloaders.dataset import RandomCrop, DualAugmentTransform
...
parser.add_argument('--num_workers', type=int, default=8, help="number workers of cpu core")
parser.add_argument('--patch_size', type=tuple, default=(96, 96, 96), help='patch size of input data')
# -- setting of BANET
...
parser.add_argument('--snapshot_path', type=str, default='./results/CVBM_4_6_3/1', help='snapshot path')
    ...
    for epoch_num in iterator:
        for _, sampled_batch in enumerate(trainloader):
            volume_batch, label_batch = \
                sampled_batch['image'][:args.labeled_bs], sampled_batch['label'][:args.labeled_bs]
...
if __name__ == "__main__":
    ...
    # shutil.copy('./just_try/Pancreas/Pancreas_train_4_6_3.py', self_snapshot_path)
    # -- Pre-Training
