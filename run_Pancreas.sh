...
wait
# python -m just_try.LA.LA_train_4_2_2 \
#     --root_path '/home/xuminghao/Datasets/LA' \
#     --gpu 0 \
#     --exp 'CVBM_LA' \
#     --model 'CVBM_Argument' \
#     --labelnum 4 \
#     --deterministic 0 \
#     --snapshot_path "./results/CVBM_4_2_highest/1" \
#     > output_LA_train_4_2_2_highest_label4_num1.log 2>&1 &
...
#     --labelnum 4 \
#     --deterministic 0 \
#     --snapshot_path "./results/CVBM_4_2_highest/2" \
#     > output_LA_train_4_2_2_highest_label4_num2.log 2>&1 &
...
python -m just_try.LA.LA_train_4_2_2 \
    ...
    --deterministic 0 \
    --snapshot_path "./results/CVBM_4_2_highest/1" \
    > ./logs/output_LA_train_4_2_2_highest_label8_num1.log 2>&1 &
...
python -m just_try.LA.LA_train_4_2_2 \
    ...
    --deterministic 0 \
    --snapshot_path "./results/CVBM_4_2_highest/2" \
    > ./logs/output_LA_train_4_2_2_highest_label8_num2.log 2>&1 &
...
#      --exp 'CVBM_LA' \
#      --model 'CVBM_Argument' \
#      --snapshot_path "./results/CVBM_4_2_highest/1" > output_test_LA_4_2_highest_label4_num1.log 2>&1 &
...
#      --exp 'CVBM_LA' \
#      --model 'CVBM_Argument' \
#      --snapshot_path "./results/CVBM_4_2_highest/2" > output_test_LA_4_2_highest_label4_num2.log 2>&1 &
...
python test_LA.py \
     ...
     --exp 'CVBM_LA' \
     --model 'CVBM_Argument' \
     --snapshot_path "./results/CVBM_4_2_highest/1" > ./logs/output_test_LA_4_2_highest_label8_num1.log 2>&1 &
...
python test_LA.py \
     ...
     --exp 'CVBM_LA' \
     --model 'CVBM_Argument' \
     --snapshot_path "./results/CVBM_4_2_highest/2" > ./logs/output_test_LA_4_2_highest_label8_num2.log 2>&1 &

wait

$HOME/send_mail.sh -t xuhaolxy@gmail.com -m "LA_train_4_2_2_highest label10% num1 and num2 training finish in 43304 4090."
...
#     --exp 'CVBM_LA' \
#     --model 'CVBM_Argument' \
#     --snapshot_path "./results/CVBM_LA/1" > output_test_LA_4_2_highest_label4_num1.log 2>&1 &
# python test_LA.py \
#     --root_path '/home/xuminghao/Datasets/LA/LA_UA-MT_Version' \
#     --labelnum 8 \
#     --exp 'CVBM_LA' \
#     --model 'CVBM_Argument' \
#     --snapshot_path "./results/CVBM_LA/1" > output_test_LA_4_2_highest_label8_num1.log 2>&1 &
# wait
# wait
