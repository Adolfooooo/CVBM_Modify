...
class ForegroundQueryBackgroundCrossAttention(nn.Module):
    """Cross-attention where foreground tokens query background tokens."""
...
class LocalCrossAttentionBlock3D(nn.Module):
    ...
    def __init__(
        ...
        self.cross_attn = ForegroundQueryBackgroundCrossAttention(
            channels=channels,
            num_heads=num_heads,
            dropout=dropout,
        )
