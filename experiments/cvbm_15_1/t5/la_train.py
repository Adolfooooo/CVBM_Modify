...
def self_train(args, pre_snapshot_path, self_snapshot_path):
    ...
    for epoch in iterator:
        for _, sampled_batch in enumerate(trainloader):
            ...
            writer.add_scalar('Self/proto_fg_cross_queries', proto_stats["proto_fg_cross_queries"], iter_num)
            writer.add_scalar('Self/proto_bg_cross_queries', proto_stats["proto_bg_cross_queries"], iter_num)
