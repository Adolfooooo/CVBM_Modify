...
from .prototype_losses import MomentumBranchPrototypeLoss
...
parser.add_argument('--proto_momentum', type=float, default=0.99, help='momentum for prototype memory update')
...
parser.add_argument('--snapshot_path', type=str, default='./results/CVBM_15_1_t2_b/1/', help='snapshot path to save model')
...
def self_train(args, pre_snapshot_path, self_snapshot_path):
    ...
    proto_criterion = MomentumBranchPrototypeLoss(
        in_channels=16,
    ...
    for epoch in iterator:
        for _, sampled_batch in enumerate(trainloader):
            ...
            writer.add_scalar('Self/proto_fg_ready', proto_stats["proto_fg_ready"], iter_num)
            writer.add_scalar('Self/proto_bg_ready', proto_stats["proto_bg_ready"], iter_num)
