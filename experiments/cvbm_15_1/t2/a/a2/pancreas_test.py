...
parser.add_argument('--exp', type=str, default='CVBM_Pancreas_15_1_a2', help='experiment name')
...
parser.add_argument('--snapshot_path', type=str, default='./results/CVBM_15_1_t2_a2_pancreas/1/',
