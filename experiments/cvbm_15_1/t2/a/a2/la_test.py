...
from experiments.cvbm_15_1.t2.a.a2.modules import CVBMArgumentWithCrossSKC3DProto
...
parser.add_argument('--exp', type=str, default='CVBM_LA_FgQBgKV_CrossSKC_A2_ProtoDenom', help='experiment name')
...
parser.add_argument('--snapshot_path', type=str, default='./results/CVBM_15_1_t2_a2/',
