...
parser.add_argument('--exp', type=str, default='CVBM_BRATS19_15_1_a2', help='exp_name')
...
parser.add_argument('--snapshot_path', type=str, default='./results/CVBM_15_1_t2_a2_brats19/1/', help='snapshot path to save model')
