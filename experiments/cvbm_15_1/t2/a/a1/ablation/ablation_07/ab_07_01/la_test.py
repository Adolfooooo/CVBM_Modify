...
parser.add_argument('--exp', type=str, default='CVBM_LA_FgStrong_BgWeak_Ablation_07_01', help='experiment name')
...
parser.add_argument('--snapshot_path', type=str, default='./results/CVBM_15_1_t2_a/a1/ablation_07/ab_07_01/1/',
