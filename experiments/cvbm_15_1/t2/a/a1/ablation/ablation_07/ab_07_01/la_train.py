...
parser.add_argument('--exp', type=str, default='CVBM_LA_FgStrong_BgWeak_Ablation_07_01', help='exp_name')
...
def pre_train(args, snapshot_path):
    ...
    for epoch_num in iterator:
        for _, sampled_batch in enumerate(trainloader):
            ...
            outputs_fg, outputs, outputs_bg, *_ = model(volume_batch_strong, volume_batch)
            loss_seg = 0
            loss_seg_dice = 0
            loss_sdf = 0
