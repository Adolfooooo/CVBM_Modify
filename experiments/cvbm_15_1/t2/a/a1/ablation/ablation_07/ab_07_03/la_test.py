...
parser.add_argument('--exp', type=str, default='CVBM_LA_FgStrong_BgStrong_Ablation_07_03', help='experiment name')
...
parser.add_argument('--snapshot_path', type=str, default='./results/CVBM_15_1_t2_a/a1/ablation_07/ab_07_03/1/',
