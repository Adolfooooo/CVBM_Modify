...
parser.add_argument('--exp', type=str, default='CVBM_Pancreas_FgStrong_BgStrong_Ablation_07_03', help='exp_name')
...
def pre_train(args, snapshot_path):
    ...
    for epoch_num in iterator:
        for _, sampled_batch in enumerate(trainloader):
            ...
            outputs_fg, outputs, outputs_bg, out_tanh, out_tanh_bg = model(volume_batch_strong, volume_batch_strong)
            loss_seg = 0
            loss_seg_dice = 0
...
if __name__ == "__main__":
    ...
    print("Starting Pancreas FG-query-BG Cross-SKC training.")
