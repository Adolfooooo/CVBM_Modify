...
parser.add_argument('--exp', type=str, default='CVBM_Pancreas_FgWeak_BgWeak_Ablation_07_02', help='exp_name')
...
parser.add_argument('--snapshot_path', type=str, default='./results/CVBM_15_1_t2_a/a1/ablation_07/ab_07_02/1/', help='snapshot path to save model')
...
def self_train(args, pre_snapshot_path, self_snapshot_path):
    ...
    for epoch in iterator:
        for _, sampled_batch in enumerate(trainloader):
            ...
            with torch.no_grad():
                unoutput_a_fg, unoutput_a, unoutput_a_bg, unoutput_a_sdm, unoutput_a_sdm_bg, _, _ = ema_model(unimg_a, unimg_a)
                unoutput_b_fg, unoutput_b, unoutput_b_bg, unoutput_b_sdm, unoutput_b_sdm_bg, _, _ = ema_model(unimg_b, unimg_b)
            ...
            mixl_img_fg = mixl_img
            mixl_img_bg = mixl_img
            mixu_img_fg = mixu_img
            mixu_img_bg = mixu_img
