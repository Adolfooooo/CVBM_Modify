...
parser.add_argument('--exp', type=str, default='CVBM_Pancreas_FgQBgKV_Ablation_ProtoPatch', help='experiment name')
...
parser.add_argument('--snapshot_path', type=str, default='./results/CVBM_15_1_t2_a/a1/ablation_04/1/',
