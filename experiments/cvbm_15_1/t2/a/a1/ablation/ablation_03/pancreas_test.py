...
# a1 ablation: evaluate the local self-attention/no-interaction SKC variant.
...
parser.add_argument('--exp', type=str, default='CVBM_Pancreas_FgQBgKV_Ablation_SKC_Self_Attention', help='experiment name')
