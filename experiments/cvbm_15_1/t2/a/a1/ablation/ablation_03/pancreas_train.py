...
parser.add_argument('--exp', type=str, default='CVBM_Pancreas_FgQBgKV_Ablation_SKC_Self_Attention', help='exp_name')
...
parser.add_argument('--snapshot_path', type=str, default='./results/CVBM_15_1_t2_a/a1/ablation_03/1/', help='snapshot path to save model')
...
if __name__ == "__main__":
    ...
    print("Starting Pancreas training with SKC self-attention ablation.")
