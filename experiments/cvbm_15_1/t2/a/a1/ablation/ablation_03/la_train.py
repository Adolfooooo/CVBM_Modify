...
parser.add_argument('--exp', type=str, default='CVBM_LA_FgQBgKV_Ablation_SKC_Self_Attention', help='exp_name')
...
if __name__ == "__main__":
    ...
    print("Starting LA training with SKC self-attention ablation.")
