...
from experiments.cvbm_15_1.t2.a.a1 import pancreas_train as pancreas_base
...
# a1 ablation defaults: keep the a1 Pancreas parser, but retarget this wrapper to the single-branch prototype experiment.
if args.exp == "CVBM_Pancreas_FgQBgKV_CrossSKC":
    args.exp = "CVBM_Pancreas_FgQBgKV_Ablation_06_SingleProtoBranch"
if args.snapshot_path == "./results/CVBM_15_1_t2_a/1/":
    args.snapshot_path = "./results/CVBM_15_1_t2_a/a1/ablation_06/1/"
...
def pre_train(local_args, snapshot_path):
    ...
    fallback_best_path = os.path.join(snapshot_path, f"{local_args.model}_best_model.pth")
    if not os.path.exists(fallback_best_path):
        pancreas_base.save_net_opt(model, optimizer, fallback_best_path)
