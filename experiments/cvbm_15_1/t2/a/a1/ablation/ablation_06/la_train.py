...
# a1 ablation: keep a1 backbone and contrast only one prototype branch.
...
parser.add_argument('--exp', type=str, default='CVBM_LA_FgQBgKV_Ablation_06_SingleProtoBranch', help='exp_name')
...
parser.add_argument('--snapshot_path', type=str, default='./results/CVBM_15_1_t2_a/a1/ablation_06/1/', help='snapshot path to save model')
...
if __name__ == "__main__":
    ...
    print("Starting LA single-branch prototype ablation training.")
