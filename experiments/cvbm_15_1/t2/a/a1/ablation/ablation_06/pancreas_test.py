...
# a1 migration: test uses the migrated ablation model binding.
...
parser.add_argument('--exp', type=str, default='CVBM_Pancreas_FgQBgKV_Ablation_06_SingleProtoBranch', help='experiment name')
...
parser.add_argument('--snapshot_path', type=str, default='./results/CVBM_15_1_t2_a/a1/ablation_06/1/',
