...
parser.add_argument('--exp', type=str, default='CVBM_BRATS19_FgQBgKV_Ablation_Without_SKC', help='exp_name')
...
parser.add_argument(
    '--snapshot_path',
    type=str,
    default='./results/CVBM_15_1_t2_a/a1/ablation_01/',
...
if __name__ == "__main__":
    ...
    print("Starting BRATS19 ablation training without SKC and with prototype contrast only.")
