...
parser.add_argument('--exp', type=str, default='CVBM_LA_Ablation_SKC_Self_Attention', help='exp_name')
...
parser.add_argument('--snapshot_path', type=str, default='./results/ablation/skc_self_attention_no_interaction/1/', help='snapshot path to save model')
