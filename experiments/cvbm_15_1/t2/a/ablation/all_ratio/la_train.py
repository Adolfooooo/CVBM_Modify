...
parser.add_argument('--exp', type=str, default='CVBM_LA_All_Ratio', help='experiment name')
...
parser.add_argument('--patch_size', type=ast.literal_eval, default=(112, 112, 80), help='training and validation patch size')
...
parser.add_argument('--snapshot_path', type=str, default='./results/CVBM_15_1/t2/a/all_ratio',
                    help='snapshot root')
