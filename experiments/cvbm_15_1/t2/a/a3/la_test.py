...
from experiments.cvbm_15_1.t2.a.a3.modules import CVBMArgumentWithCrossSKC3DProto
...
parser.add_argument('--exp', type=str, default='CVBM_LA_FgQBgKV_CrossSKC_A3_SampleProto', help='experiment name')
...
parser.add_argument('--snapshot_path', type=str, default='./results/CVBM_15_1_t2_a3/',
