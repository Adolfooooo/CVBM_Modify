...
parser.add_argument('--exp', type=str, default='CVBM_LA_FgQBgKV_CrossSKC_A4_SampleLocalProto', help='exp_name')
...
parser.add_argument('--snapshot_path', type=str, default='./results/CVBM_15_1_t2_a4/', help='snapshot path to save model')
