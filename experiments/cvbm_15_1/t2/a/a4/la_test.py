...
from experiments.cvbm_15_1.t2.a.a4.modules import CVBMArgumentWithCrossSKC3DProto
from utils.test_3d_patch import test_all_case_argument


parser = argparse.ArgumentParser()
parser.add_argument('--root_path', type=str, default='/root/LA', help='LA dataset root')
parser.add_argument('--exp', type=str, default='CVBM_LA_FgQBgKV_CrossSKC_A4_SampleLocalProto', help='experiment name')
...
parser.add_argument('--snapshot_path', type=str, default='./results/CVBM_15_1_t2_a4/',
