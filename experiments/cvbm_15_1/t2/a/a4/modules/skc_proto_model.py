...
class SemanticKnowledgeCrossInteraction3D(nn.Module):
    """Foreground-query background interaction module at the bottleneck feature level."""
    ...
    def forward(
        ...
        fg_refined, bg_context = self.local_block(fg_resized, bg_resized)
        fg_refined, _ = self.global_block(fg_refined, bg_context)
        ...
        return fg_feature + fg_delta, bg_feature
