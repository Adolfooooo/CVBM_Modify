...
from experiments.cvbm_11_1.modules import CVBMArgumentWithSKC3D
...
def self_train(args, pre_snapshot_path, self_snapshot_path):
    ...
    ema_model = net_factory(net_type=args.model, in_chns=1, class_num=num_classes, mode="train").cuda()
