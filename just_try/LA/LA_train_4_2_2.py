...
parser.add_argument('--snapshot_path', type=str, default='./results/CVBM_LA_4_2_2/1/', help='snapshot path to save model')
...
def self_train(args, pre_snapshot_path, self_snapshot_path):
    ...
    for epoch in iterator:
        for _, sampled_batch in enumerate(trainloader):
            ...
            pos_patches, neg_patches = select_patches_for_contrast_3d(output_mix_bg_fg, topnum=16, patch_size=(4, 4, 4))
