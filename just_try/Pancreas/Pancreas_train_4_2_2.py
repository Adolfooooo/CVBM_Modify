...
parser.add_argument('--snapshot_path', type=str, default='./results/CVBM_4_2_2/1', help='snapshot path')
...
if __name__ == "__main__":
    ...
    shutil.copy('./just_try/Pancreas/Pancreas_train_4_2_2.py', self_snapshot_path)
    # -- Pre-Training
