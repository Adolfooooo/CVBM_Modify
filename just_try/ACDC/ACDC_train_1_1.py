...
def self_train(args, pre_snapshot_path, snapshot_path):
    ...
    for _ in iterator:
        for _, sampled_batch in enumerate(trainloader):
            ...
            out_max_1, out_max_2 = \
                torch.max(torch.softmax(out_1, dim=1).detach(), dim=1)[0], torch.max(torch.softmax(out_2, dim=1).detach(), dim=1)[0]
            ...
            loss = loss_1 + pseudo_supervision3 + pseudo_supervision4
...
if __name__ == "__main__":
    ...
    # -- path to save models
    pre_snapshot_path = "./results/CVBM/ACDC_{}_{}_labeled/pre_train".format(args.exp, args.labelnum)
    self_snapshot_path = "./results/CVBM/ACDC_{}_{}_labeled/self_train".format(args.exp, args.labelnum)
