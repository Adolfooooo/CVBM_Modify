...
def self_train(args, pre_snapshot_path, snapshot_path):
    ...
    for _ in iterator:
        for _, sampled_batch in enumerate(trainloader):
            ...
            loss = loss_1 + pseudo_supervision3 + pseudo_supervision4 + pseudo_supervision1 + pseudo_supervision2
...
if __name__ == "__main__":
    ...
    # -- path to save models
    pre_snapshot_path = "./results/CVBM_ACDC_1_2/ACDC_{}_{}_labeled/pre_train".format(args.exp, args.labelnum)
    self_snapshot_path = "./results/CVBM_ACDC_1_2/ACDC_{}_{}_labeled/self_train".format(args.exp, args.labelnum)
