...
def self_train(args, pre_snapshot_path, snapshot_path):
    ...
    for _ in iterator:
        for _, sampled_batch in enumerate(trainloader):
            ...
            image_output_soft_1 = torch.softmax(out_fg_abd, dim=1)
            pseudo_image_output_1 = torch.argmax(image_output_soft_1.detach(), dim=1, keepdim=False)
            image_output_soft_2 = torch.softmax(out_bg_abd, dim=1)
            ...
            loss = loss_dice + loss_ce + loss_consist_l + loss_consist_u + loss_consist_abd
...
if __name__ == "__main__":
    ...
    # -- path to save models
    pre_snapshot_path = "./results/CVBM_ACDC_2_2/4/ACDC_{}_{}_labeled/pre_train".format(args.exp, args.labelnum)
    self_snapshot_path = "./results/CVBM_ACDC_2_2/4/ACDC_{}_{}_labeled/self_train".format(args.exp, args.labelnum)
