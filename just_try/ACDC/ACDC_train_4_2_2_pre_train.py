...
parser.add_argument('--snapshot_path', type=str, default='./results/CVBM_4_2_2_pre_train/1', help='snapshot_path')
...
def self_train(args, pre_snapshot_path, snapshot_path):
    ...
    for _ in iterator:
        for _, sampled_batch in enumerate(trainloader):
            ...
            pos_patches, neg_patches = select_patches_for_contrast(output_mix, topnum=64, patch_size=(8, 8), choose_largest=False)
            # 现在形状满足你的要求：
