...
#     > ./logs/output_brats19_train_4_6_3_aug_contrastive20,8,8,48_label10%_num2.log 2>&1 &
...
#     --deterministic 0 \
#     --snapshot_path "./results/CVBM_4_6_3/2" \
#     > ./logs/output_brats19_train_4_6_3_aug_contrastive20,8,8,48_label20%_num2.log 2>&1 &
wait
...
python test_brats19.py \
     ...
     --exp 'CVBM_BRATS19' \
     --model 'CVBM_Argument' \
     --snapshot_path "./results/CVBM_4_6_3/2" > ./logs/output_test_brats19_train_4_6_3_aug_contrastive20,8,8,48_label10%_num2.log 2>&1 &
...
python test_brats19.py \
     ...
     --exp 'CVBM_BRATS19' \
     --model 'CVBM_Argument' \
     --snapshot_path "./results/CVBM_4_6_3/2" > ./logs/output_test_brats19_train_4_6_3_aug_contrastive20,8,8,48_label20%_num2.log 2>&1 &
wait
